...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onPause() {
        ...
        SharedPreferences sharedPreferences=getSharedPreferences("sharma.shiv.Knowledge",MODE_PRIVATE);
        SharedPreferences.Editor editor=sharedPreferences.edit();
        editor.putString("mail","chhail.bihari_mca18@gla.ac.in");
